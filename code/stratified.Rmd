...
length(sig_indices_2)
sig_raw_count_2 <- raw_count_stage2[sig_indices_2,] 
```
```{r}
intersection <- intersect(intersect(row.names(sig_raw_count_2), row.names(sig_raw_count_3)), row.names(sig_raw_count_4))
intersection
```