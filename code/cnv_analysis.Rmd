...
clinical <- read.table("/data/gpfs-1/users/phgi10_c/work/Uni/MultiOmic_Datascience/data/TCGA-BLCA.survival.tsv",sep = "\t", stringsAsFactors=FALSE, header=TRUE)
```

```{r}
#sample_clin <- gsub("TCGA-[0-9A-Z]*-[0-9A-Z]*-","",clin)
```
...
#"01" "11" "06"
unique(types)
samples <- unique(gsub("-[0-9A-Z]*-[0-9A-Z]*-01$", "", CN[,1]))
